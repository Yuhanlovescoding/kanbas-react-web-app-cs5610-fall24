...
export default function WorkingWithArrays() {
  ...
  return (
    ...
    <h3>Updating an Item in an Array</h3>
      ...
      <h3>Editing an Item in an Array</h3>
    ...
    <a id="wd-retrieve-completed-todos" className="btn btn-primary float-end" href={`${API}/${todo.id}/completed/true`}>
    Complete Todo with ID = {todo.id} </a>
    <input defaultValue={todo.id} className="form-control w-50" onChange={(e) => setTodo({ ...todo, id: e.target.value })}/><hr/>
